...
const Footer = () => {
  return (
    <footer className="mt-auto bg-finzo-black border-t border-muted/20 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="text-xl font-bold text-gradient mb-2">Finzo</div>
            <p className="text-sm text-muted-foreground">
              Simplifying financial decisions for everyone
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-muted/20 flex flex-col md:flex-row justify-between items-center">
